...
public class CanvasCreationExecutor extends AbstractCanvasExecutor {



    private final String CANVAS_PROPS_PATTERN = "^(?<width>\\d+)\\s(?<height>\\d+)\\s*$";


    public CanvasCreationExecutor(CanvasService canvasService) {
        super(canvasService);
    }
